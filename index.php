    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                ...
                <a href="./user/register.php" class="btn btn-success btn-lg">Bergabung Sekarang</a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="./pages/bank-sampah.php" class="btn btn-success btn-lg">Mulai Sekarang</a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="./pages/Education.php" class="btn btn-success btn-lg">Pelajari Lebih Lanjut</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    ...
                    <i class="fas fa-building text-success mb-3" style="font-size: 3rem;"></i>
                        ...
                        <a href="./pages/bank-sampah.php" class="btn btn-outline-success">Selengkapnya</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="./pages/Education.php" class="btn btn-outline-success">Selengkapnya</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="./pages/lapor.php" class="btn btn-outline-success">Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>
